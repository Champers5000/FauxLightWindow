...
#define DAC1
#define DAC2
#define I2C_IS_BUSY() ((!(TWI0.MSTATUS & TWI_BUSSTATE_IDLE_gc))?true:false)
...
void DACinit(){
  ...
  TWI0.CTRLA = 0;
  TWI0.MBAUD = calcBaudRate(100000, 0.1f);
  TWI0.MCTRLA = 0x01;
...
bool I2C_Write(uint8_t address, uint8_t *pData, uint8_t dataLength){
  if(I2C_IS_BUSY()){
    return false;
  }
